      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            const SizedBox(height: 20),
            ElevatedButton(
              child: const Text("Add T&P Coordinator"),
              onPressed: () async {},
            ),
            const SizedBox(height: 20),
            ElevatedButton(
              child: const Text("Delete T&P Coordinator"),
              onPressed: () async {},
            ),
            const SizedBox(height: 20),
            ElevatedButton(
          ...
          content: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SelectableLinkify(
                  text:
                      '${metadataQuerySnapshot.docs.firstWhere((element) => element.id == "SheetsUrl").get(action == "create" ? "createUsers" : "deleteUsers").toString()}',
                  onOpen: _onOpen,
                  toolbarOptions:
